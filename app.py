...
class App:
    ...
    def init_gui(self):
        ...
        self.classname_one = simpledialog.askstring("Classname 1st", "Enter the name of the first class:", parent=self.window)
        self.classname_two = simpledialog.askstring("Classname 2nd", "Enter the name of the second class:", parent=self.window)
